...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
    ...
    <div class="labels">
           <ul style="padding:10px 0px; margin:0px; list-style:none;">
                  <li>
                    <input class="styled-checkbox" id="styled-checkbox-1" type="checkbox" value="value1" required="required">
                    <label for="styled-checkbox-1">I agree to Pure Smile Online's <a href="https://puresmilesonline.com/terms-and-conditions/">Terms & Conditions</a></label>
                  </li>
